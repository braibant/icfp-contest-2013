...
module Problem = struct
  ...
  type return = [
  | (* 200 *) `Problem_body of response list
...
module Training = struct
  ...
  type return = [
  | (* 200 *) `Training_body of training_problem
  | (* 400 *) `Bad_request
  | (* 403 *) `Authorization_required
  | (* 429 *) `Try_again_later
  ]

  and training_problem = {
