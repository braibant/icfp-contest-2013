...
let combine acc n = Hashtbl.hash (n, acc)
let combine2 acc n1 n2 = Hashtbl.hash (acc, n1, n2)
let combine3 acc n1 n2 n3 = Hashtbl.hash (acc, n1, n2, n3)
let combine_list f acc l = Hashtbl.hash (acc::List.map f l)
